...
<template>
  <header class="sticky top-0 z-999" :class="isTop ? ' bg-white/30 dark:bg-black/30 backdrop-blur-sm' : ''">
    <div class="relative mx-auto flex items-center justify-between px-3 py-4 container md:py-4.5 sm:py-4">
