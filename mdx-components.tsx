...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    h1: ({ children }) => (
      <h1 className="text-3xl font-bold mb-4 mt-8 text-[#333] dark:text-[#bdc1c6]">
        {children}
      </h1>
    ),
    h2: ({ children }) => (
      <h2 className="text-2xl font-semibold mb-3 mt-6 text-[#333] dark:text-[#bdc1c6]">
        {children}
      </h2>
    ),
    h3: ({ children }) => (
      <h3 className="text-xl font-semibold mb-2 mt-4 text-[#333] dark:text-[#bdc1c6]">
        {children}
      </h3>
    ),
    p: ({ children }) => (
