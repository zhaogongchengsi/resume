    ...
    <ErrorPageWrapper>
      <div className="min-h-screen flex items-center justify-center bg-white dark:bg-[#202124]">
        <div className="text-left max-w-[600px] px-5 py-10">
          ...
          <h1 className="text-2xl font-normal mb-4 text-[#333] dark:text-[#bdc1c6]">{t('title')}</h1>
          <p className="text-sm leading-relaxed mb-3 text-[#333] dark:text-[#bdc1c6]">
            <strong><DomainDisplay /></strong> {t('description')}
          </p>
          <div className="my-8 p-5 bg-[#f5f5f5] dark:bg-[#2d2e30] rounded">
            ...
            <ul className="list-disc pl-8 m-0">
              <li className="mb-2 text-sm text-[#333] dark:text-[#bdc1c6]">{t('checkConnection')}</li>
              <li className="mb-2 text-sm text-[#333] dark:text-[#bdc1c6]">{t('checkProxy')}</li>
              <li className="mb-2 text-sm text-[#333] dark:text-[#bdc1c6]">{t('runDiagnostics')}</li>
            </ul>
          </div>
          <p className="text-xs text-[#999] dark:text-[#666] mt-8 font-mono">{t('errorCode')}</p>
        </div>
      </div>
    </ErrorPageWrapper>
  )
